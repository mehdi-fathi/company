...
final class Version20240208075405 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "users" (id SERIAL NOT NULL, name VARCHAR(100) NOT NULL, role public."role_user" NOT NULL, company_id INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('COMMENT ON COLUMN "users".role IS \'(DC2Type:role_user)\'');
    }
